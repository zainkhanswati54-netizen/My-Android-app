...
// ═══════════════════════════════════════════════════════
//  SECRET ADMIN BUTTON — login page ke bottom pe
//  Ek invisible dot dikhti hai, usse 7 baar tap karo
//  Admin Dashboard khul jata hai (PIN se protected)
// ═══════════════════════════════════════════════════════

class _SecretAdminButton extends StatefulWidget {
  @override
  State<_SecretAdminButton> createState() => _SecretAdminButtonState();
}

class _SecretAdminButtonState extends State<_SecretAdminButton> {
  int _taps = 0;
  static const int _required = 7;
          ...
          child: Center(
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: _taps > 0
                    ? cGreen.withOpacity(0.4 + (_taps / _required) * 0.6)

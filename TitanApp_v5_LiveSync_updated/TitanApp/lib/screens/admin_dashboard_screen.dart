        ...
        Expanded(child: _loading
          ...
          : SingleChildScrollView(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                // ── Summary stats ──────────────────────
                Row(children: [
                  Expanded(child: _StatBox(icon: Icons.mic_rounded,           label: 'Generations',  value: '$_totalGens',                   color: cGreen)),
                  const SizedBox(width: 8),
                  Expanded(child: _StatBox(icon: Icons.check_circle_rounded,  label: 'Success',      value: '$_successGens',                 color: cBlue)),
                  const SizedBox(width: 8),
                  Expanded(child: _StatBox(icon: Icons.text_fields_rounded,   label: 'Chars',        value: _fmtNum(_totalChars),            color: cAmber)),
                ]),
                const SizedBox(height: 8),
                Row(children: [

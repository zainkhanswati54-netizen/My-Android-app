...
// ═══════════════════════════════════════════════
//  TITAN STUDIO PRO v2.0 — OBSIDIAN NEON THEME
// ═══════════════════════════════════════════════
...
// Helper: flag SVG path — uses existing file if available, else default
String _flag(String code) {
  const existing = {'en', 'hi', 'ur'};
  return existing.contains(code)
      ? 'assets/svg/lang_$code.svg'
      : 'assets/svg/lang_default.svg';
}
...
class CharConfig {
  ...
  // Which language names (keys in kLanguages) this character is best suited for

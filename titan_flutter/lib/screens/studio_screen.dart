...
class _StudioState extends State<StudioScreen> {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Row(children: [
          ...
          const Text('Wrong Language', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: cText2)),
        ]),
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Row(children: [
          ...
          SizedBox(width: 10),
          Text('Saved!', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: cText2)),
        ]),
  ...
  Widget _buildHeader() => Container(
    ...
    child: Row(children: [
      Container(
        width: 42, height: 42,
        decoration: BoxDecoration(color: cGreen, borderRadius: BorderRadius.circular(12)),
        child: const Center(child: Text('T', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: Colors.white))),
      ),
      const SizedBox(width: 10),
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('Titan Studio PRO', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: cText2)),
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  const SizedBox(height: 4),
                  Text(e.key, style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: selected ? Colors.white : cText2)),
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  const SizedBox(height: 4),
                  Text(e.key, style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: selected ? Colors.white : cText2)),
                ]),
              ),
            );
          }).toList(),
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Row(children: [
                  ...
                  Text(lang, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: sel ? Colors.white : cText2)),
                  const Spacer(),
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Center(child: Column(children: [
                  ...
                  const SizedBox(height: 4),
                  Text(g, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: sel ? Colors.white : cText2)),
                ])),
              ),
            );
          }),
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text(e.key, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: sel ? Colors.white : cText2)),
              ]),
            ),
          );
        }).toList(),
  ...
  Widget _advToggle(String label, bool val, ValueChanged<bool> onChanged) => Padding(
    ...
    child: Row(children: [
      Expanded(child: Text(label, style: const TextStyle(fontSize: 13, color: cText))),
      Switch.adaptive(
  ...
  Widget _buildStatusCard() => MintCard(
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        ...
        const SizedBox(width: 8),
        Expanded(child: Text(_status, style: const TextStyle(fontSize: 13, color: cText))),
      ]),
      const SizedBox(height: 10),
      ClipRRect(

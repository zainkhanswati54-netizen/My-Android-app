...
class _StudioState extends State<StudioScreen> {
  ...
  void initState() {
    super.initState();
    // Text change hone par button update karo
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                Text(e.value.icon, style: TextStyle(
                  fontSize: 14,
                  color: allowed ? null : Colors.white24,
                )),
  ...
  Widget _buildGenerateBtn() {
    ...
    final disabled = _generating || isEmpty;
    return GestureDetector(
    ...
    child: AnimatedContainer(
      ...
      child: Center(child: _generating
        ...
        : Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            const SizedBox(width: 10),
            Text(
              isEmpty ? 'Enter Text First' : 'Generate Audio',
    ...
    Expanded(child: GestureDetector(
      ...
      child: Container(
        ...
        child: const Center(child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          SizedBox(width: 8),
          Text('Downloads', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: cPurple)),
        ])),
      ),
    )),
  ]);

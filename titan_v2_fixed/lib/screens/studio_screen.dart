                ...
                child: Stack(
                  children: [
                    Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Center(child: Text(e.value.icon, style: TextStyle(fontSize: 22, color: blocked ? Colors.white24 : null))),
                      const SizedBox(height: 4),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 11,
              color: _textCtrl.text.length >= 200 ? cRed : cMuted,
              fontWeight: _textCtrl.text.length >= 200 ? FontWeight.w700 : FontWeight.normal,
            ),
          ),
          const SizedBox(width: 8),
          GestureDetector(
        ...
        if (_textCtrl.text.length >= 200) ...[
          ...
          Container(
            ...
            child: const Row(children: [
              ...
              SizedBox(width: 6),
              Expanded(child: Text('Only 200 characters supported', style: TextStyle(fontSize: 11, color: cRed, fontWeight: FontWeight.w600))),
            ]),
          ),
        ],
        const SizedBox(height: 10),
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
                borderSide: BorderSide(color: _textCtrl.text.length >= 200 ? cRed : cGreen, width: 2),
              ),
              enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
                borderSide: BorderSide(color: _textCtrl.text.length >= 200 ? cRed.withOpacity(0.5) : cBorder),
              ),

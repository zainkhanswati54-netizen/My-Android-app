...
class _SettingsState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    appBar: AppBar(
      ...
      title: const Text('Settings', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: cText2)),
      ...
      children: [
        ...
        MintCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          ...kLanguages.entries.map((e) => Padding(
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(e.key, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: cText2)),
        ...
        MintCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          ...[
            ...
            '🎙️  Powered by Microsoft Edge TTS',

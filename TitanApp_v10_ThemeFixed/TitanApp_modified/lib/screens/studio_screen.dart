...
class _StudioState extends State<StudioScreen>
  ...
  Widget _buildLangGender() => Builder(builder: (context) {
    ...
    final bgSurface  = isDark ? cSurface  : const Color(0xFFEBEFF5);
    final bgCard     = isDark ? cBg2      : const Color(0xFFF0F3F8);
                ...
                children: filtered.map((lang) {
                  ...
                  return GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: sel ? cGreen : bgCard,
                        borderRadius: BorderRadius.circular(10),
                        border: Border.all(
                            color: sel ? cGreen : borderCol.withOpacity(0.6)),
                      ),
                      child: Row(children: [

...
// ═══════════════════════════════════════════════
//  LIGHT THEME PALETTE — Soft Pearl
// ═══════════════════════════════════════════════
const Color cLBg      = Color(0xFFF5F7FA);
const Color cLBg2     = Color(0xFFEBEFF5);
const Color cLCard    = Color(0xFFFFFFFF);
const Color cLCard2   = Color(0xFFF0F3F8);
const Color cLBorder  = Color(0xFFD0D9E8);
const Color cLText    = Color(0xFF0F1B2D);
const Color cLText2   = Color(0xFF4A5568);
const Color cLMuted   = Color(0xFF8A99AD);
const Color cLSurface = Color(0xFFEBEFF5);

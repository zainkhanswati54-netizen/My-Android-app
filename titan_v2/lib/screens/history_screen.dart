...
class _HistoryState extends State<HistoryScreen> {
  ...
  Widget build(BuildContext context) => Scaffold(
    backgroundColor: cBg,
    appBar: AppBar(
      backgroundColor: cBg2, elevation: 0, foregroundColor: cText2,
      title: const Text('Voice History', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: cText2)),
      actions: [
                ...
                child: MintCard(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(e.filename, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: cText2), maxLines: 1, overflow: TextOverflow.ellipsis),

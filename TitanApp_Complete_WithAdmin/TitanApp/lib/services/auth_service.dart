  ...
  static Future<AuthResult> signInWithGoogle() async {
    try {
      ...
      if (googleAuth.idToken == null) {
        return AuthResult.error('Google auth failed. Please add SHA1 fingerprint in Firebase Console.');
      }
      ...
      if (s.contains('10:') || s.contains('DEVELOPER_ERROR')) {
        return AuthResult.error('SHA1 fingerprint missing. Add it in Firebase → Project Settings → Your App.');
      }

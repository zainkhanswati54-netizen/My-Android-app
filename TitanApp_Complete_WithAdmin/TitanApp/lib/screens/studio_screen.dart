  ...
  Future<void> _loadDisabledChars() async {
    try {
      ...
      if (mounted) {
        ...
        // If currently selected character is disabled, switch to first enabled
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(
            ...
            child: Builder(builder: (ctx) {
              ...
              if (filtered.isEmpty) {
                return const Center(child: Text('No language found', style: TextStyle(fontSize: 12, color: cMuted)));
              }
              return ListView(
                  ...
                  return GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      child: Row(children: [
                        ...
                        Text(lang, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700,
                          color: sel ? Colors.white : cText)),
                        const Spacer(),
                        Text(cfg.label, style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800,
        ...
        Row(children: [
          Expanded(child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: cSurface,
                borderRadius: BorderRadius.circular(8),
                border: Border.all(color: cBorder)),
              child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                Icon(Icons.refresh_rounded, size: 14, color: cMuted),
                SizedBox(width: 4),
                Text('Clear', style: TextStyle(fontSize: 11, color: cMuted, fontWeight: FontWeight.w600)),
              ]),
            ),
          )),
          const SizedBox(width: 6),
          Expanded(child: GestureDetector(
            onTap: () async {
              ...
              if (data?.text != null && data!.text!.isNotEmpty) {
                final text = data.text!.length > 1000
                    ? data.text!.substring(0, 1000) : data.text!;
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: cSurface,
                ...
                border: Border.all(color: cBorder)),
              child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                Icon(Icons.content_paste_rounded, size: 14, color: cMuted),
                SizedBox(width: 4),
                Text('Paste', style: TextStyle(fontSize: 11, color: cMuted, fontWeight: FontWeight.w600)),
              ]),
            ),
          )),
          const SizedBox(width: 6),
          Expanded(child: GestureDetector(
            onTap: () {
              final chars = kCharacters.keys.toList();
              final random = chars[Random().nextInt(chars.length)];
              _applyCharacter(random);
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text('🎲 Random: $random'),
                backgroundColor: cGreen3, duration: const Duration(seconds: 1)));
            },
            child: Container(
              padding: const EdgeInsets.symmetric(vertical: 7),
              decoration: BoxDecoration(color: cSurface,
                ...
                border: Border.all(color: cBorder)),
              child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                Icon(Icons.casino_rounded, size: 14, color: cMuted),
                SizedBox(width: 4),
                Text('Random', style: TextStyle(fontSize: 11, color: cMuted, fontWeight: FontWeight.w600)),
              ]),
            ),
          )),
        ]),
    ...
    Expanded(child: GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: cSurface,
          ...
          border: Border.all(color: cBorder)),
        child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Icon(Icons.refresh_rounded, size: 15, color: cMuted),
          SizedBox(width: 4),
          Text('Reset', style: TextStyle(fontSize: 12, color: cMuted, fontWeight: FontWeight.w600)),
        ]),
      ),
    )),
    const SizedBox(width: 8),
    ...
    Expanded(child: GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: cSurface,
          ...
          border: Border.all(color: cBorder)),
        child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Icon(Icons.content_paste_rounded, size: 15, color: cMuted),
          SizedBox(width: 4),
          Text('Paste', style: TextStyle(fontSize: 12, color: cMuted, fontWeight: FontWeight.w600)),
        ]),
      ),
    )),
    const SizedBox(width: 8),
    ...
    Expanded(child: GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: cSurface,
          ...
          border: Border.all(color: cBorder)),
        child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Icon(Icons.casino_rounded, size: 15, color: cMuted),
          SizedBox(width: 4),
          Text('Random', style: TextStyle(fontSize: 12, color: cMuted, fontWeight: FontWeight.w600)),
        ]),
      ),
    )),
  ]);

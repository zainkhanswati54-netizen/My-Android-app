...
class SplashScreen extends StatefulWidget {
  ...
  final VoidCallback? onComplete;  // callback when splash finishes
  const SplashScreen({super.key, this.autoNavigate = true, this.onComplete});
  @override
...
class _SplashState extends State<SplashScreen> with TickerProviderStateMixin {
  ...
  void _startProgress() async {
    ...
    if (widget.onComplete != null) {
      // Let parent (_AuthGate) decide where to go
      widget.onComplete!();
    } else if (widget.autoNavigate) {
      // Direct navigation (login screen usage)

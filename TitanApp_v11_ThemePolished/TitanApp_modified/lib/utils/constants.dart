...
// ═══════════════════════════════════════════════
//  LIGHT THEME PALETTE — Slate Clean
// ═══════════════════════════════════════════════
const Color cLBg      = Color(0xFFF8FAFC);  // Slate 50
const Color cLBg2     = Color(0xFFFFFFFF);  // Pure White
const Color cLCard    = Color(0xFFFFFFFF);
const Color cLCard2   = Color(0xFFF1F5F9);
const Color cLBorder  = Color(0xFFE2E8F0);
const Color cLText    = Color(0xFF0F172A);  // Dark Slate
const Color cLText2   = Color(0xFF475569);
const Color cLMuted   = Color(0xFF94A3B8);
const Color cLSurface = Color(0xFFF1F5F9);
const Color cLAccent  = Color(0xFF0284C7);  // Deep Sky Blue
const Color cLRed     = Color(0xFFE11D48);  // Rose 600

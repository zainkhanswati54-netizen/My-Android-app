      ...
      children: [
        ...
        MintCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          ...[
            ...
            _aboutRow(Icons.language_rounded,         'Urdu, Hindi, English Support'),
            _aboutRow(Icons.people_rounded,           '8 Characters + 8 Voice Presets'),
            _aboutRow(Icons.sentiment_satisfied_rounded, '8 Emotions + Speed/Pitch Control'),
          ],
          const Padding(
            padding: EdgeInsets.only(top: 4),
            child: Text('© 2025 Titan Studio PRO', style: TextStyle(fontSize: 12, color: cMuted)),
          ),
        ])),

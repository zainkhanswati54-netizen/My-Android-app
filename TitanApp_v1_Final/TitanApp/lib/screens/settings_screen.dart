    ...
    body: ListView(
      ...
      children: [
        ...
        MintCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 10),
          ...[
            _aboutRow(Icons.rocket_launch_rounded,       'Titan Studio PRO  v1.0'),
            ...
            _aboutRow(Icons.closed_caption_rounded,      'Word-Boundary Sync (Karaoke/Avatar)'),
            _aboutRow(Icons.code_rounded,                'Full SSML Markup Support'),
            _aboutRow(Icons.record_voice_over_rounded,   'Custom Neural Voice (CNV) — Beta'),
            _aboutRow(Icons.translate_rounded,           'Cross-Lingual Voice Persona'),
            _aboutRow(Icons.brand_awareness_rounded,     'Brand Voice Persona System'),
          ],
          const Padding(

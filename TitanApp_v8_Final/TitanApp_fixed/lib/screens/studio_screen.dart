                  ...
                  return GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: sel
                            ? cGreen
                            : (_character.isNotEmpty
                                ? cBg2   // non-matching gender dimmed
                                : cSurface),
                        borderRadius: BorderRadius.circular(10),
                        border: Border.all(
                            color: sel
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: sel
                        ...
                        : (locked ? cBg2 : cSurface),
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: sel
                          ? cGreen
                          : (locked
                              ? cBorder.withOpacity(0.25)
                              : cBorder),
                      width: sel ? 1.5 : 1,
                    ),
                    boxShadow: sel
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      // Gender symbol (text-based, no SVG needed)
                      Text(
                        isMale ? '♂' : '♀',
                        style: TextStyle(
                          fontSize: 18,
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: sel
                              ? cGreen
                              : (locked ? cMuted.withOpacity(0.4) : cText2),
                        ),
                      ),
                      if (locked) ...[
                        const SizedBox(width: 4),

...
// ═══════════════════════════════════════════════════════
//  AD SERVICE v1.0
//  Reads config from Firebase AdminAdData
//  Supports: Banner, Interstitial, Rewarded
//  Test Mode: ON by default (safe)
// ═══════════════════════════════════════════════════════
...
class AdService {
  ...
  // ══════════════════════════════════════════════════════
  //  INITIALIZE  — call once in main() after Firebase init
  // ══════════════════════════════════════════════════════
  ...
  // ══════════════════════════════════════════════════════
  //  BANNER AD WIDGET
  //  Use: AdService.buildBannerAd() in any screen
  // ══════════════════════════════════════════════════════
  ...
  // ══════════════════════════════════════════════════════
  //  INTERSTITIAL — auto-shows based on frequency setting
  //  Call this after every generation
  // ══════════════════════════════════════════════════════
    ...
    try {
      await InterstitialAd.load(
        ...
        adLoadCallback: InterstitialAdLoadCallback(
          ...
          onAdFailedToLoad: (_, __) => _interstitialAd = null,
        ),
      );
    } catch (_) {}
  }
  ...
  // ══════════════════════════════════════════════════════
  //  REWARDED AD  — user watches for +5 extra requests
  // ══════════════════════════════════════════════════════
    ...
    try {
      await RewardedAd.load(
        ...
        rewardedAdLoadCallback: RewardedAdLoadCallback(
          ...
          onAdFailedToLoad: (_, __) => _rewardedAd = null,
        ),
      );
    } catch (_) {}
  }
